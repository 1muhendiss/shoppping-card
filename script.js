...
async getproducts() {
  try{
let result = await fetch("https://663223eac51e14d695637ce6.mockapi.io/products");
...
class UI {
   ...
   getBagButtons() {
    const buttons = [...document.querySelectorAll(".btn-add-to-card")];//array şeklinde alması için böyle yapıyoruz
    buttonsDOM = buttons;
    buttons.forEach(button => {
       ...
       if(inCart){
        ...
        cart = [...cart, cartItem];//*cart'ın içinde ne kadar item varsa onu al cartItem'ları(yani seçtiğim kartları) da buna ekle bu satırın anlamı bu
       //save cart in local storage
       Storage.saveCart(cart);//her eklediğimizi al saveCart fonksiyonuna gönder
